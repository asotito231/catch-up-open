...
export class NavComponent implements OnInit{
  ...
  searchArticlesForSource(source: any){
    ...
    this.newsApi.getArticlesBySourceId(source.id).subscribe((data: any) => {this.articles = data['articles'];
      this.articles.forEach((article: { source: { urlToLogo: any; url: any; }; }) => {article.source.urlToLogo = source.urlToLogo;
